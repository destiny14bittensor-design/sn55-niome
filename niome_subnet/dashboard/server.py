...
FLEET_LANES = (
    ...
    MinerLaneConfig(
        ...
        label="dollar2",
        uid=243,
        hotkey="5Cd42XsDyg9QGovQKCVffbd2nk6cpfQbsCLZo4FF2fhLoveS",
    ...
    MinerLaneConfig(
        ...
        label="dollar3",
        uid=45,
        hotkey="5EFDuGe2nXZfb3cRG1K8KTs6ihePcMMUCsSJdcn9fLaaW6mT",
    ...
    MinerLaneConfig(
        ...
        label="dollar4",
        uid=198,
        hotkey="5ES1fyTQdvQjtmGokDSsb3fw2MyvzygAQ1oiRKiy9MDJwqKU",
...
async def state() -> JSONResponse:
    return JSONResponse(collector.miner_snapshot("dollar1"))
    ...
    async def stream():
        ...
        while not await request.is_disconnected():
            ...
            if version != last_version:
                payload = json.dumps(
                    collector.miner_snapshot("dollar1"),
                    ensure_ascii=False,
                    separators=(",", ":"),
                )
                yield f"event: state\ndata: {payload}\n\n"
